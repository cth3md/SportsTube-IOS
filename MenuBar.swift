...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        cv.backgroundColor = UIColor.rgb(31, green: 32, blue: 230)
        cv.dataSource = self
        cv.delegate = self
        return cv
    }()
    ...
    let cellId = "cellId"
    let imageNames = ["football", "baseball", "hockey", "basketball"]
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        cell.tintColor = UIColor.rgb(13, green: 14, blue: 91)
...
class MenuCell: BaseCell {
    ...
    let imageView: UIImageView = {
        let iv = UIImageView()
        iv.image = UIImage(named: "hockey")?.imageWithRenderingMode(.AlwaysTemplate)
        iv.tintColor = UIColor.rgb(13, green: 14, blue: 91)
        return iv
    }()
    
    override var highlighted: Bool {
        didSet {
            imageView.tintColor = highlighted ? UIColor.whiteColor() : UIColor.rgb(13, green: 14, blue: 91)
        }
    }
    
    override var selected: Bool {
        didSet {
            imageView.tintColor = selected ? UIColor.whiteColor() : UIColor.rgb(13, green: 14, blue: 91)
        }
    }
